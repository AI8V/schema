...
const DynamicPromptGenerator = (function () {
    ...
    // ===================================================================
    //  1. القالب الأساسي للبرومبت (The Master Prompt Template v2.0.2 - CORRECTED)
    // ===================================================================

    /**
     * القالب الأساسي للبرومبت المحصّن والنهائي.
     * ملاحظة: تم استبدال كل علامات الـ backticks (`) بعلامات اقتباس فردية (') لمنع أخطاء الجافاسكريبت.
     * @type {string}
     */
